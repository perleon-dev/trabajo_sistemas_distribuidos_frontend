...
import { AdvanceService } from '../services/advanceServices/advance.service';
...
export class CargaMasivaComponent implements OnInit {
  ...
  getFiltroIdSuma():void{
    ...
    this.contractService.getPreContractTradenameSearch(constants.STATE.ACTIVE).subscribe((response:any) => {
      var filter_tradename = response.filter(el => el.tradename != null); // evito los null

      // evito datos repetidos
      var tradename = {};
      var unico_tradename = filter_tradename.filter(function (e) { 
